	...
	<form action = "formarray.php" method = "POST">
		<table>
			...
			<tr>
				...
				<th>
					<input type="checkbox" name="ck[]" value="Kehadiran >= 70%"> Kehadiran >= 70% <br>
					<input type="checkbox" name="ck[]" value="Interaktif dikelas"> Interaktif dikelas <br>
					<input type="checkbox" name="ck[]" value="Tidak terlambat mengumpulkan tugas">Tidak terlambat mengumpulkan tugas <br>
				</th>
			</tr>
			<tr>
				<th></th>
