...
<div>
	<?php echo get('q')!=""?"hasil pencarian untuk '".(get('q'))."'":"";?></div> 
		...
		<tbody> 
			<?php $i = 1; foreach ($data as $key) { ?> 
				<tr> 
					...
					<td><?php echo $key['logo'];?></td> 
					<td><a target="_blank" href="proses/sekolah/pdf.php?id=<?php echo $key['id'];?>">PDF</a></td> <td><a href="proses/sekolah/download.php?id=<?php echo $key['id'];?>">Download</a></td> 
					<td><a href="index.php?p=sekolah&m=edit&id=<?php echo $key['id'];?>">Ubah</a></td> <td><a onclick="return confirm('Hapus Data<?php echo $key['nama'];?>')" <a href="proses/sekolah/hapus.php?id=<?php echo $key['id'];?>">Hapus</a></td> </tr> <?php $i++; } ?> 
				</tbody> 
			</table>